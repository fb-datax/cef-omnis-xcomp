...
//----- Construction and destruction -----------------------------------
    ...
    // Smart copy
    Win32Error( const Win32Error& rRHS )
        : m_szErrMsg( NULL )
    {
        addRef( rRHS );
    }
    ...
    Win32Error( unsigned int dwLastError )
        : m_szErrMsg( NULL )
    {
    ...
    // Smart copy.
    const Win32Error& operator=( const Win32Error& rRHS )
    {
        if( this != &rRHS )
        {
            releaseRef();
...
private:
    ...
    void addRef( const Win32Error& rOrig )
    {
...
//======================================================================
// class Win32Error Interface and Implementation ends here.
////////////////////////////////////////////////////////////////////////


////////////////////////////////////////////////////////////////////////
//
//  Win32Error Example Usages:
//  ========================== 
// 
...
//             --------------------------------------------------
//
//  void MyFunction( void ) throw Win32Error // see client below
//  {
//      if( ! SomeWin32API() ) 
//      {
...
//          MyFunction();
//      }
//      catch( Win32Error e ) // catching by value is OK (smart copying)
//      {
...
//             ---------------------------------------
//
//  // This function returns a Win32Error object. Smart copy
...
//      // in the returned Win32Error object.
//
...
//          {
//              // This form of Win32Error ctor does NOT call 
//              // ::GetLastError().
//
//              Win32Error e = dwErr; 
//              
//              // Win32Error supplies const char* conversion
//
//              AfxMessageBox( e );
//          }
...
////////////////////////////////////////////////////////////////////////
//
// Technical Notes for Win32Error:
// ===============================
// 
...
// ---------------------------------------------
// (i) You have to remember to call Win32Error::ReGetLastError() 
...
// perfectly OK to create Win32Error objects on the heap.
//
