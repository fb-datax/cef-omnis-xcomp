...
void RendererApp::OnWebKitInitialized() {
	...
	std::string code =
		...
		"    MSGBOXICON_YESNO: 4,"
		"    MSGBOXICON_NOYES: 5,"
		"    MSGBOXCANCEL_YESNO: 6,"
		"    MSGBOXCANCEL_NOYES: 7,"
		"  };"
		"(function() {"
		"  omnis.showMsg = function(msg, bell, type) {"
		"    native function sendOmnis();"
		"    bell = (bell === undefined) ? true : !!bell;"
		"    if(isNaN(type) || type < 0 || type > 7) type = omnis.MSGBOXICON_OK;"
		"    arg = {msg: String(msg), bell: bell, type: type};"
		"    return sendOmnis('showMsg', JSON.stringify(arg));"
		"  };"
		"  omnis.traceLog = function() {"
		"    native function sendOmnis();"
		"    var args = Array.prototype.slice.call(arguments);"
		"    return sendOmnis('traceLog', args.map(String).join(' '));"
		"  };"
